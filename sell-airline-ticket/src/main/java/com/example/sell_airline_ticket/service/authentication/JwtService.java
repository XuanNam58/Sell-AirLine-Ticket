...
public class JwtService {
    private static final String SECRET_KEY =
            "Y2VydC1kZXZlbG9wbWVudC1pbnRlcm5hbC1rZXktc2VjcmV0LWhpcy1leGFtcGxlLXN0cmluZw==";
    ...
    public boolean validateToken(String token) {
        try {
            Jwts.parser().setSigningKey(getSigningKey()).parseClaimsJws(token); // Xác thực chữ ký của token
